...
class ServiceDetailsImgAdapter(var context: Context, var list: ArrayList<String>) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(
            DataBindingUtil.inflate(
                LayoutInflater.from(parent.context), R.layout.service_datails_img_design, parent, false
            )
        )
    }

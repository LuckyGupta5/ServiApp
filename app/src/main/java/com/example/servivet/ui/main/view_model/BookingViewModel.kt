...
class BookingViewModel : BaseViewModel() {
    ...
    fun hitSoldBookingListAPI(myBookingStatus: Int, page: Int, limit: Int) {
        ...
        viewModelScope.launch {
            try {
                soldBookingListResponse.postValue(
                    Resource.success(
                        repository.mysoldbookingListApi(
                            soldRequest
                        )
                    )
                )
    ...
    fun hitCancelBookingApi() {
        ...
        viewModelScope.launch {
            try {
                cancelBookingResponse.postValue(
                    Resource.success(
    ...
    fun hitAcceptBookingApi() {
        ...
        viewModelScope.launch {
            try {
                acceptBookingResponse.postValue(
                    Resource.success(
                        repository.acceptBookingApi(
